...
import { IUserDetails, UserDetails, Language } from 'app/shared/model/user-details.model';
...
describe('Service Tests', () => {
    describe('UserDetails Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new UserDetails(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', Language.ENGLISH);
        });
