...
import io.trtong.repository.IngredientRepository;
...
public class IngredientResourceIntTest {
    ...
    public void createIngredient() throws Exception {
        ...
        assertThat(testIngredient.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
    ...
    public void updateIngredient() throws Exception {
        ...
        assertThat(testIngredient.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
