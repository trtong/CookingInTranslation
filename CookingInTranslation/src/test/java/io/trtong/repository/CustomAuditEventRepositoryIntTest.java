...
import io.trtong.config.audit.AuditEventConverter;
import io.trtong.domain.PersistentAuditEvent;
...
import static io.trtong.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
