...
public class UserDetails implements Serializable {
    ...
    public UserDetails recipes(Set<Recipe> recipes) {
        this.recipes = recipes;
        return this;
    }

    public UserDetails addRecipe(Recipe recipe) {
        this.recipes.add(recipe);
        recipe.getUserDetails().add(this);
        return this;
    }

    public UserDetails removeRecipe(Recipe recipe) {
        this.recipes.remove(recipe);
        recipe.getUserDetails().remove(this);
        return this;
    }
