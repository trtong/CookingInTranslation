...
import io.trtong.repository.UserDetailsRepository;
...
public class UserDetailsResourceIntTest {
    ...
    private static final Language DEFAULT_LANGUAGE_PREFERENCE = Language.ENGLISH;
    private static final Language UPDATED_LANGUAGE_PREFERENCE = Language.SPANISH;
    ...
    public void createUserDetails() throws Exception {
        ...
        assertThat(testUserDetails.getLanguagePreference()).isEqualTo(DEFAULT_LANGUAGE_PREFERENCE);
    }
    ...
    public void getAllUserDetails() throws Exception {
        ...
        restUserDetailsMockMvc.perform(get("/api/user-details?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].languagePreference").value(hasItem(DEFAULT_LANGUAGE_PREFERENCE.toString())));
    }
    ...
    public void getUserDetails() throws Exception {
        ...
        restUserDetailsMockMvc.perform(get("/api/user-details/{id}", userDetails.getId()))
            ...
            .andExpect(jsonPath("$.languagePreference").value(DEFAULT_LANGUAGE_PREFERENCE.toString()));
    }
    ...
    public void updateUserDetails() throws Exception {
        ...
        updatedUserDetails
            ...
            .email(UPDATED_EMAIL)
            .languagePreference(UPDATED_LANGUAGE_PREFERENCE);
        ...
        assertThat(testUserDetails.getLanguagePreference()).isEqualTo(UPDATED_LANGUAGE_PREFERENCE);
    }
