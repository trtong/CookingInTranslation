...
public class TranslatedRecipe implements Serializable {
    ...
    private Recipe translatedRecipe;
    ...
    public Recipe getTranslatedRecipe() {
        return translatedRecipe;
    }

    public TranslatedRecipe translatedRecipe(Recipe recipe) {
        this.translatedRecipe = recipe;
        return this;
    }

    public void setTranslatedRecipe(Recipe recipe) {
        this.translatedRecipe = recipe;
    }
