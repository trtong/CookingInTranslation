...
public interface RecipeRepository extends JpaRepository<Recipe, Long> {
    ...
    @Query(value = "select distinct recipe from Recipe recipe left join fetch recipe.userDetails",
    ...
    @Query("select recipe from Recipe recipe left join fetch recipe.userDetails where recipe.id =:id")
