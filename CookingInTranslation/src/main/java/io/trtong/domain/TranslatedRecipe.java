...
public class TranslatedRecipe implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("translatedRecipes")
    private CookBook translatedRecipes;
    ...
    public CookBook getTranslatedRecipes() {
        return translatedRecipes;
    }

    public TranslatedRecipe translatedRecipes(CookBook cookBook) {
        this.translatedRecipes = cookBook;
        return this;
    }

    public void setTranslatedRecipes(CookBook cookBook) {
        this.translatedRecipes = cookBook;
    }
